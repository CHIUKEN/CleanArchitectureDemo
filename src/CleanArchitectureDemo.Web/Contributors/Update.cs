...
using FastEndpoints;
using CleanArchitectureDemo.Web.Endpoints.ContributorEndpoints;
using CleanArchitectureDemo.UseCases.Contributors.Create;
using CleanArchitectureDemo.UseCases.Contributors.Update;
using MediatR;
using Ardalis.Result;

namespace CleanArchitectureDemo.Web.ContributorEndpoints;
